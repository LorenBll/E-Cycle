...
CREATE TABLE IF NOT EXISTS `interactions` (
  ...
  PRIMARY KEY (`ID`),
  KEY `id_user` (`id_user`),
  CONSTRAINT `FK_interactions_users` FOREIGN KEY (`id_user`) REFERENCES `users` (`ID`) ON DELETE SET NULL ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `negotiations` (
  ...
  CONSTRAINT `FK_negotiations_sing_offer` FOREIGN KEY (`id_sing_offer`) REFERENCES `sing_offers` (`ID`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `FK_negotiations_sing_requests` FOREIGN KEY (`id_sing_request`) REFERENCES `sing_requests` (`ID`) ON DELETE CASCADE ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `sing_offers` (
  ...
  CONSTRAINT `FK_sing_offer_characteristics` FOREIGN KEY (`id_characteristics`) REFERENCES `characteristics` (`ID`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `FK_sing_offer_interactions` FOREIGN KEY (`id_offer`) REFERENCES `interactions` (`ID`) ON DELETE CASCADE ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `sing_requests` (
  ...
  KEY `id_characteristics` (`id_characteristics`),
  CONSTRAINT `FK_sing_request_characteristics` FOREIGN KEY (`id_characteristics`) REFERENCES `characteristics` (`ID`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `FK_sing_request_requests` FOREIGN KEY (`id_request`) REFERENCES `interactions` (`ID`) ON DELETE CASCADE ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `ts_passwordUpdate` timestamp NOT NULL DEFAULT current_timestamp(),
